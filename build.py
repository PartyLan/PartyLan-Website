...
def validate_home(h):
    ...
    expected_hrefs={'How it works':'/#how-it-works','Shared Moments':'/#gallery','FAQ':'/#faq','Packages':'/packages/','Make your own':'/packages/#make-your-own','Contact':'/#booking','Terms of Service':'/terms/','Privacy Policy':'/privacy/'}
    ...
    if se.get('href')!='/#booking': err(f,'packages_page.shared_enquiry.href','expected /#booking')
